...
/*!
   ...
   This property contains the complete URL of the KDUpdater::UpdateFile downloaded by this update.
...
/*!
   ...
   If this property is true, you can get the complete name of the downloaded KDUpdater::UpdateFile in #downloadedFileName.

   Get this property's value using %isDownloaded().

   \note The downloaded KDUpdater::UpdateFile will be deleted when this class is destroyed
*/

/*!
   \property KDUpdater::Update::downloadedFileName

   This property contains the name of the downloaded KDUpdater::UpdateFile after the download is complete, i.e. when downloaded is @c true.
...
/*!
   Returns data for a given key @p name, or an invalid QVariant if the data doesn't exist.
*/
...
/*!
   Returns a list of operations needed by this update. For example, a package update needs to change
   the package version, a compat update needs to change the compat level.
 */
