...
/*!
   ...
   The user can also retrieve some information from this class:
   \li target name
   \li target version
   \li compat level
*/
...
/*!
   ...
   If you manually set this to another value, Target does not check wheter the directory exists.
