...
/*!
 ...
 A KDSearchLineEdit is a QLineEdit containing a magnifier icon. Additionally, it can
...
QSize KDSearchLineEdit::minimumSizeHint() const
{
    ...
    if( isMacStyle( style() ) )
    {
        const QPixmap pmLeft = QPixmap( RESOURCE( "searchlineedit_focus_left" ) );;
        const QPixmap pmRight = QPixmap( RESOURCE( "searchlineedit_focus_right" ) );;
