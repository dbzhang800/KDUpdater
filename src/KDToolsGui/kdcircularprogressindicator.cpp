...
/*!
 ...
 user about a process currently running in the background. It doesn't really
...
/*!
 ...
 Specifies wheter the circular progress indicator is active or not. Even if the
