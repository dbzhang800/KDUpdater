...
/*!
  Set \a codec as the the codec to use for encoding unicode. If \a
...
/*!
  ...
  \param deleteFile If @c true, the file is deleted before writing the
  first log entry. The default is to append to the file if it already
  exists.
 */
...
/*!
  ...
  \ingroup kdlog
  \brief A KDLogDevice that writes to the system log. On UNIX this means
