...
!build_pass:qmakeCleanAndCopy("$$KDUPDATER_SOURCE_TREE/examples/data/firmwaredemo/appdir", "$$EXAMPLE_APP_DIR")
...
qmakeEcho("    <Url>file:///$${KDUPDATER_SOURCE_TREE}/examples/firmwaredemo/updateserver</Url>", ">>", "$$EXAMPLE_APP_DIR/UpdateSources.xml")
qmakeEcho("  </UpdateSource>", ">>", "$$EXAMPLE_APP_DIR/UpdateSources.xml")
qmakeEcho("</UpdateSources>", ">>", "$$EXAMPLE_APP_DIR/UpdateSources.xml")
