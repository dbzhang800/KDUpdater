...
!build_pass:qmakeCleanAndCopy("$$KDTOOLS_SOURCE_TREE/examples/data/kdupdater/simpleexample/appdir", "$$EXAMPLE_APP_DIR")
...
qmakeEcho("    <Url>file:///$${KDTOOLS_SOURCE_TREE}/examples/kdupdater/simpleexample/updateserver</Url>", ">>", "$$EXAMPLE_APP_DIR/UpdateSources.xml")
qmakeEcho("  </UpdateSource>", ">>", "$$EXAMPLE_APP_DIR/UpdateSources.xml")
qmakeEcho("</UpdateSources>", ">>", "$$EXAMPLE_APP_DIR/UpdateSources.xml")
